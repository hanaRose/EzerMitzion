...
import { IWidgetOneProps } from './IWidgetOneProps';
import { ICardItem } from '../../services/ListService';
import styles from './WidgetOne.module.scss';

const WidgetOne: React.FC<IWidgetOneProps> = ({ listService }) => {
          ...
          >
            {item.IsLarge ? (
              <div className={styles.cardContent}>
                {item.IconUrl && <img src={item.IconUrl} alt={item.Title} className={styles.icon} />}
